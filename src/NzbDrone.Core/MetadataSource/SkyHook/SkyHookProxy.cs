    ...
    public class SkyHookProxy : IProvideSeriesInfo, IProvideArtistInfo, ISearchForNewSeries
    {
        ...
        public List<Artist> SearchForNewArtist(string title)
        {
            try
            {
                ...
                _logger.Debug("Searching for " + lowerTitle);
                ...
                var httpRequest = _requestBuilder.Create()
                                    .SetSegment("route", "search/artist/" + title.ToLower().Trim())
                                    .Build();
        ...
        private static Album MapAlbum(AlbumResource resource)
        {
            ...
            album.AlbumType = resource.Type ?? "Standard";
        ...
        private static Artist MapArtist(ArtistResource resource)
        {
            ...
            //artist.Images = resource.Artists.Items[0].Images; // TODO: Pull artist Images
